...
class RewardsDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(
        () => controller.isRewardLoading.value?Center(child: CircularProgressIndicator(),): Column(
          children: [
            Expanded(
                    ...
                    Stack(
                      children: [
                        SizedBox(
                          ...
                          height: 300.h,
                          child: CommonImage(
                            src: controller.reward.value?.rewardImage ?? '',
                            fill: BoxFit.cover,
                          ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              (offer.value?.whatsIncluded != null &&
                                      offer.value!.whatsIncluded.isNotEmpty)
                                  ? ListView.separated(
                                      itemBuilder: (context, index) =>
                                          _buildIncludedItem(
                                            offer.value!.whatsIncluded[index],
                                          ),
                                      separatorBuilder: (context, index) =>
                                          12.height,
                                      itemCount: offer.value!.whatsIncluded.length,
                                      shrinkWrap: true,
                                    )
                                  : SizedBox(),
              ...
              child: Column(
                children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            4.height,
                            CommonText(
                              text: "${offer.value?.visitorPoints??0} Points",
                              fontSize: 16.sp,
                              fontWeight: FontWeight.w700,
                              textColor: AppColor.darkColor,
                            ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            4.height,
                            CommonText(
                              text: "${offer.value?.rewardPoints??0} Points",
                              fontSize: 16.sp,
                              fontWeight: FontWeight.w700,
                              textColor: AppColor.darkColor,
                            ),
                  ...
                  CommonButton(
                    ...
                    onTap: () {
                      Get.toNamed(AppRoute.redemNowScreen,arguments: {'redeemId':offer.value?.id??''});
                    },
                  ),
                ],
              ),
